...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(spacex_df, values='Launch Site', 
        names='Launch Site', 
        title='All Sites')
        return fig
    else:
...
def get_scatter(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        fig= px.scatter(filtered_df2, x= "Payload Mass (kg)", y="class",color="Booster Version",title=f"Correlation between Payload and Success for Site {entered_site}")
        return fig
